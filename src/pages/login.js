...
const Login = () => {
    ...
    return (
        <div className="bg-red-400 h-screen w-screen flex justify-center items-center">
            <div className="h-[40vh] w-[20vw] border border-red-600 rounded-xl">
                ...
                <form className="flex flex-col gap-6 items-center my-10" onSubmit={(e) => handleLogin(e, data)}>
                    ...
                    <button className="bg-white text-red-400 px-6 py-2 rounded-xl mt-12 transition-all hover:bg-[#efefef]">
                        Submit
                    </button>
                </form>
            </div>
